...
1. **sql_queries.py** is where I  define SQL statements, which will be imported into the two other files.
2. **create_tables.py** is where I create fact and dimension tables for the star schema in Redshift.
3. **etl.py** is where I load data from S3 into staging tables on Redshift and then process that data into  analytics tables on Redshift.. 
